...
create table foto_produto (content_type varchar(255) not null, descricao varchar(255), nome_arquivo varchar(255) not null, tamanho bigint, produto_id bigint not null, primary key (produto_id)) engine=InnoDB;
