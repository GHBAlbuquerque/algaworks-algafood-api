...
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('Senhor Glutão', 12.50, 5, 1, '38400999', 'Rua João Pinheiro', '1000', 'Centro', utc_timestamp, utc_timestamp, true);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('Thai Gourmet', 15.50, 1, 2, '38400999', 'Rua João Pinheiro', '1000', 'Centro', utc_timestamp, utc_timestamp, true);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('Larica', 3.00, 5, 3, '38400999', 'Rua João Pinheiro', '1000', 'Centro',  utc_timestamp, utc_timestamp, true);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('TukTuk Delivery', 1.00, 6, 4, '38400999', 'Rua João Pinheiro', '1000', 'Centro',  utc_timestamp, utc_timestamp, true);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('La Pururuca', 0.50, 7, 5, '38400999', 'Rua João Pinheiro', '1000', 'Centro',  utc_timestamp, utc_timestamp, true);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('Fish and Chips', 18.50, 2, 1, '38400999', 'Rua João Pinheiro', '1000', 'Centro',  utc_timestamp, utc_timestamp, true);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao, ativo) values ('Burguer King', 0, 8, 2, '38400999', 'Rua João Pinheiro', '1000', 'Centro',  utc_timestamp, utc_timestamp, true);
