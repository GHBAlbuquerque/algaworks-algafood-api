...
create table foto_produto (id bigint not null auto_increment, content_type varchar(255) not null, descricao varchar(255), nome varchar(255) not null, tamanho bigint, primary key (id)) engine=InnoDB;
...
create table item_pedido (id bigint not null auto_increment, observacao varchar(255), preco_total decimal(19,2) not null, preco_unitario decimal(19,2) not null, quantidade integer not null, produto_id bigint not null, itens_id bigint not null, primary key (id)) engine=InnoDB;
create table pedido (id bigint not null auto_increment, data_cancelamento date, data_confirmacao date, data_criacao date not null, data_entrega date, endereco_bairro varchar(255) not null, endereco_cep varchar(255) not null, endereco_complemento varchar(255), endereco_logradouro varchar(255) not null, endereco_numero varchar(255) not null, status integer not null, subtotal decimal(19,2) not null, taxa_frete decimal(19,2) not null, valor_total decimal(19,2) not null, cliente_id bigint not null, endereco_cidade_id bigint not null, forma_pagamento_id bigint not null, restaurante_id bigint not null, primary key (id)) engine=InnoDB;
...
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255), nome varchar(255) not null, preco decimal(19,2) not null, foto_id bigint, restaurante_id bigint not null, primary key (id)) engine=InnoDB;
...
create table usuario (id bigint not null auto_increment, data_cadastro datetime not null, email varchar(255), nome varchar(255) not null, senha varchar(255), primary key (id)) engine=InnoDB;
...
alter table item_pedido add constraint FKkxu0p5vp8xj2cao248wtd83is foreign key (itens_id) references pedido (id);
...
alter table produto add constraint FK6vyyy4jbqvti6ok6r3a83rpsi foreign key (foto_id) references foto_produto (id);
...
alter table restaurante_responsavel add constraint FKd03nytc197478v9ol6v3uwclm foreign key (usuario_id) references usuario (id);
alter table restaurante_responsavel add constraint FKqnvoj62e875igcampb46f6tmv foreign key (restaurante_id) references restaurante (id);
...
create table permissao (id bigint not null auto_increment, descricao varchar(255), nome varchar(255) not null, primary key (id)) engine=InnoDB;
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255), nome varchar(255) not null, preco decimal(19,2) not null, foto_id bigint, restaurante_id bigint not null, primary key (id)) engine=InnoDB;
create table restaurante (id bigint not null auto_increment, data_atualizacao datetime not null, data_cadastro datetime not null, endereco_bairro varchar(255) not null, endereco_cep varchar(255) not null, endereco_complemento varchar(255), endereco_logradouro varchar(255) not null, endereco_numero varchar(255) not null, nome varchar(255) not null, taxa_frete decimal(19,2), cozinha_id bigint not null, endereco_cidade_id bigint not null, primary key (id)) engine=InnoDB;
create table restaurante_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB;
create table restaurante_responsavel (restaurante_id bigint not null, usuario_id bigint not null) engine=InnoDB;
create table usuario (id bigint not null auto_increment, data_cadastro datetime not null, email varchar(255), nome varchar(255) not null, senha varchar(255), primary key (id)) engine=InnoDB;
create table usuario_grupo (usuario_id bigint not null, grupo_id bigint not null) engine=InnoDB;
...
create table permissao (id bigint not null auto_increment, descricao varchar(255), nome varchar(255) not null, primary key (id)) engine=InnoDB;
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255), nome varchar(255) not null, preco decimal(19,2) not null, foto_id bigint, restaurante_id bigint not null, primary key (id)) engine=InnoDB;
create table restaurante (id bigint not null auto_increment, ativo bit not null, data_atualizacao datetime not null, data_cadastro datetime not null, endereco_bairro varchar(255) not null, endereco_cep varchar(255) not null, endereco_complemento varchar(255), endereco_logradouro varchar(255) not null, endereco_numero varchar(255) not null, nome varchar(255) not null, taxa_frete decimal(19,2), cozinha_id bigint not null, endereco_cidade_id bigint not null, primary key (id)) engine=InnoDB;
create table restaurante_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB;
create table restaurante_responsavel (restaurante_id bigint not null, usuario_id bigint not null) engine=InnoDB;
create table usuario (id bigint not null auto_increment, data_cadastro datetime not null, email varchar(255), nome varchar(255) not null, senha varchar(255), primary key (id)) engine=InnoDB;
create table usuario_grupo (usuario_id bigint not null, grupo_id bigint not null) engine=InnoDB;
