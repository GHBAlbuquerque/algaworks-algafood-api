...
create table pedido (id bigint not null auto_increment, codigo varchar(255) not null, data_cancelamento date, data_confirmacao date, data_criacao date, data_entrega date, subtotal decimal(19,2), taxa_frete decimal(19,2), valor_total decimal(19,2), restaurante_id bigint, primary key (id)) engine=InnoDB;
...
create table grupo (id bigint not null auto_increment, nome varchar(255) not null, primary key (id)) engine=InnoDB;
create table grupo_permissao (grupo_id bigint not null, permissao_id bigint not null) engine=InnoDB;
create table item_pedido (id bigint not null auto_increment, observacao varchar(255), preco_total decimal(19,2), preco_unitario decimal(19,2), quantidade integer, primary key (id)) engine=InnoDB;
create table pedido (id bigint not null auto_increment, codigo varchar(255) not null, data_cancelamento date, data_confirmacao date, data_criacao date, data_entrega date, subtotal decimal(19,2), taxa_frete decimal(19,2), valor_total decimal(19,2), restaurante_id bigint, primary key (id)) engine=InnoDB;
create table permissao (id bigint not null auto_increment, descricao varchar(255), nome varchar(255) not null, primary key (id)) engine=InnoDB;
create table produto (id bigint not null auto_increment, ativo bit, descricao varchar(255), nome varchar(255) not null, preco decimal(19,2), foto_id bigint, restaurante_id bigint, primary key (id)) engine=InnoDB;
create table restaurante (id bigint not null auto_increment, data_atualizacao datetime not null, data_cadastro datetime not null, endereco_bairro varchar(255) not null, endereco_cep varchar(255) not null, endereco_complemento varchar(255), endereco_logradouro varchar(255) not null, endereco_numero varchar(255) not null, nome varchar(255) not null, taxa_frete decimal(19,2), cozinha_id bigint not null, endereco_cidade bigint not null, primary key (id)) engine=InnoDB;
create table restaurante_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB;
create table restaurante_produtos (restaurante_id bigint not null, produtos_id bigint not null) engine=InnoDB;
create table restaurante_responsavel (restaurante_id bigint not null, usuario_id bigint not null) engine=InnoDB;
